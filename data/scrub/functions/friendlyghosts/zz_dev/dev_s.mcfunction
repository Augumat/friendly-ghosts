...
# set world spawn at the origin so command block tower is always loaded
...
setblock 0 253 0 minecraft:chain_command_block[conditional=false,facing=down]{auto:1,Command:"execute at @p[team=blind] run scoreboard players set @a[team=ghost,distance=16..32] outOfBounds 1"}
...
setblock 0 243 0 minecraft:chain_command_block[conditional=false,facing=down]{auto:1,Command:"execute as @a[team=ghost] run execute if score @s outOfBounds matches 1 run execute if score @s relX > gamestate zero positioned as @s run tp @s ~-1 ~ ~"}
setblock 0 242 0 minecraft:chain_command_block[conditional=false,facing=down]{auto:1,Command:"execute as @a[team=ghost] run execute if score @s outOfBounds matches 1 run execute if score @s relX < gamestate zero positioned as @s run tp @s ~1 ~ ~"}
setblock 0 241 0 minecraft:chain_command_block[conditional=false,facing=down]{auto:1,Command:"execute as @a[team=ghost] run execute if score @s outOfBounds matches 1 run execute if score @s relY > gamestate zero positioned as @s run tp @s ~ ~-1 ~"}
setblock 0 240 0 minecraft:chain_command_block[conditional=false,facing=down]{auto:1,Command:"execute as @a[team=ghost] run execute if score @s outOfBounds matches 1 run execute if score @s relY < gamestate zero positioned as @s run tp @s ~ ~1 ~"}
setblock 0 239 0 minecraft:chain_command_block[conditional=false,facing=down]{auto:1,Command:"execute as @a[team=ghost] run execute if score @s outOfBounds matches 1 run execute if score @s relZ > gamestate zero positioned as @s run tp @s ~ ~ ~-1"}
setblock 0 238 0 minecraft:chain_command_block[conditional=false,facing=down]{auto:1,Command:"execute as @a[team=ghost] run execute if score @s outOfBounds matches 1 run execute if score @s relZ < gamestate zero positioned as @s run tp @s ~ ~ ~1"}
# handle local teleportation (like enderpearls)
setblock 0 237 0 minecraft:chain_command_block[conditional=false,facing=down]{auto:1,Command:"execute at @p[team=blind] run tp @a[team=ghost,distance=32..] @p[team=blind]"}
